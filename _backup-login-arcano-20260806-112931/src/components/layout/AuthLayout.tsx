import { CheckCircle2, Gem, LockKeyhole, Orbit, Sparkles, Users } from 'lucide-react';
      ...
      <section className="crypt-auth-story relative hidden h-full overflow-hidden border-r border-white/[0.06] p-12 lg:flex lg:flex-col xl:p-16">
        ...
        <div className="relative z-10 my-auto max-w-xl py-16">
          ...
          <p className="mt-6 max-w-lg text-base leading-7 text-crypt-muted">
            O Crypt reúne servidores, mensagens e chamadas em uma atmosfera arcana, tecnológica e
          ...
          <div aria-hidden="true" className="crypt-auth-orbit-preview mt-10">
            <span className="crypt-auth-orbit-preview__ring" />
            <span className="crypt-auth-orbit-preview__core">
              <img alt="" src="/crypt-mark.svg" />
            </span>
            <span className="crypt-auth-orbit-preview__rune crypt-auth-orbit-preview__rune--one" />
            <span className="crypt-auth-orbit-preview__rune crypt-auth-orbit-preview__rune--two" />
            <span className="crypt-auth-orbit-preview__rune crypt-auth-orbit-preview__rune--three" />
          </div>
        </div>
